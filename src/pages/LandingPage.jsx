    ...
    <div className="relative min-h-[85vh] flex flex-col lg:flex-row items-center justify-center gap-12 lg:gap-20 py-12 lg:py-0 overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto text-center space-y-10 z-10 animate-fade-in-up flex flex-col items-center">
        ...
        <div className="flex flex-col sm:flex-row gap-5 pt-4 justify-center w-full sm:w-auto px-6">
          <button onClick={() => setView('shop')} className="w-full sm:w-auto min-h-[64px] bg-gradient-to-r from-orange-500 to-amber-500 text-white px-10 py-4 rounded-full font-extrabold text-xl hover:from-orange-600 hover:to-amber-600 shadow-xl shadow-orange-500/40 hover:shadow-orange-500/60 transition-all duration-300 hover:-translate-y-1.5 flex items-center justify-center gap-3 group active:scale-95 border border-orange-400">
            Start Shopping <ChevronRight className="group-hover:translate-x-2 transition-transform" />
          </button>
          <button onClick={() => setView('auth')} className="w-full sm:w-auto min-h-[64px] bg-white/90 backdrop-blur-md border-2 border-slate-200 text-slate-800 px-10 py-4 rounded-full font-extrabold text-xl hover:border-orange-400 hover:text-orange-600 transition-all duration-300 active:scale-95 shadow-md hover:shadow-xl hover:shadow-orange-500/10 hover:-translate-y-1.5">
            Sign In / Register
          </button>
        </div>
      ...
      {/* Floating Aesthetic Glass Elements */}
